    ...
    <div class="container-fluid">
        <div class="main row">
            <div class="col-12">
                    ...
                    <div class="col ms-2">
                        <div class="header-text-full d-flex justify-content-between align-items-end">
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{route('user.referral.bonus')}}" class="btn-custom"><i class="la la-money-bill"></i> @lang('Referral Bonus')</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="">
                    <div class="">
                        <div class="search-bar refferal-link coin-box-wrapper mb-3">
                            <form class="mb-3">
                                                                ...
                                                                <tr id="user-{{ $user->id }}" data-level="0" data-loaded="false">
                                                                    <td data-label="@lang('Username')">
                                                                        <a href="javascript:void(0)"
                                                                           class="{{ $user->referrals_count > 0 ? 'nextDirectReferral' : '' }}"
                                                                           data-id="{{ $user->id }}"
                                                                        >
