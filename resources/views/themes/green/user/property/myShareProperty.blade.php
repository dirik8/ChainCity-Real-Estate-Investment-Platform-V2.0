                                ...
                                <div class="mt-15 d-flex justify-content-between align-items-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <button
                                                    class="dropdown-item updateShare btn"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="" method="post" class="deleteRoute">
                        @csrf
                        @method('delete')
                        <button type="submit" class="btn-custom cmn-btn">@lang('Remove')</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <form action="" method="post" id="invest-form" class="login-form update_share">
                ...
                <div class="modal-content">
                            ...
                            <div class="card-body">
                                <div id="formModal" class="investModalPaymentForm mt-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                               class="payable_amount shareAmount form-control @error('amount') is-invalid @enderror"
                                               name="amount"
                                               id="amount"
                                               value="{{old('amount')}}"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn-custom cmn-btn2 btn-secondary close_invest_modal close__btn"
                                data-bs-dismiss="modal">@lang('Close')</button>
                        <button type="submit" class="btn-custom investModalSubmitBtn cmn-btn">@lang('Update')</button>
                    </div>
                </div>
            </form>
        </div>
