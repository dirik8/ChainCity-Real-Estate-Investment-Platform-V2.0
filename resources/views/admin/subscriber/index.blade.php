...
@section('content')
        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">@lang("All Subscribers")</h1>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="filter_form">
                                                <div class="row">
                                                    <div class="mb-4">
                                                        <span class="text-cap text-body">@lang('email')</span>
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <input type="text" class="form-control"
                                                                       id="email_filter_input"
                                                                       autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <div class="modal fade" id="deleteSubscriberModal" tabindex="-1" role="dialog"
         aria-labelledby="loginAsSubscriberModalLabel"
         data-bs-backdrop="static"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="loginAsSubscriberModalLabel"><i
                            class="fas fa-plus-circle me-1"></i> @lang('Delete Subscriber')</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="POST" action="" enctype="multipart/form-data" class="deleteSubscriberForm">
                    @csrf
                    @method('delete')
                    <div class="modal-body">

                        <p>@lang('Are you sure to delete this subscriber?')</p>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                columns: [
                    ...
                    {data: 'subscriber_at', name: 'subscriber_at'},
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                let filterEmail = $('#email_filter_input').val();
                let filterDate = $('#filter_date_range').val();

                const datatable = HSCore.components.HSDatatables.getItem(0);
                datatable.ajax.url("{{ route('admin.subscriber.search') }}" + "?filterEmail=" + filterEmail + "&filterDate=" + filterDate).load();
            });
            ...
            $(document).on('click', '.deleteSubscriber', function () {
                ...
                $('.deleteSubscriberForm').attr('action', dataRoute);
            });
