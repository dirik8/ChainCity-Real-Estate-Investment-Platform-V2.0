                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                ...
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{ $ticketRecord[0]['totalTicket'] }}</span>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ $ticketRecord[0]['answerTicket'] }}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{ $ticketRecord[0]['totalTicket'] }}</span>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ $ticketRecord[0]['repliedTicket'] }}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{ $ticketRecord[0]['totalTicket'] }}</span>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ $ticketRecord[0]['closedTicket'] }}</span>
