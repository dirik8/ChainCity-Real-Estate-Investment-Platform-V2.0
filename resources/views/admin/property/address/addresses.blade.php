                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang("Addresses")</li>
                        </ol>
                    </nav>

                    <h1 class="page-header-title">@lang("All Addresses")</h1>
                </div>
                @if(adminAccessRoute(config('permissionList.Manage_Property.Address.permission.add')))
                    <div class="col-sm-auto">
                        <a class="btn btn-primary" href="{{ route('admin.address.create') }}">
                            <i class="fas fa-plus-circle me-1"></i>
                            @lang('Create New Address')
                        </a>
                    </div>
                @endif
            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="filter_form">
                                                <div class="row">
                                                    <div class="mb-4">
                                                        <span class="text-cap text-body">@lang('Address')</span>
                                                        <div class="row">
                                                            <div class="col-12">
    ...
    <div class="modal fade" id="deleteAddressModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="" enctype="multipart/form-data" class="deleteAddressForm">
                    @csrf
                    @method('delete')
                    <div class="modal-body">

                        <p>@lang('Are you sure to delete this address?')</p>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.address.search") }}",
                },
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                let filterAddress = $('#address_filter_input').val();
                let filterStatus = $('#filter_status').val();

                const datatable = HSCore.components.HSDatatables.getItem(0);
                datatable.ajax.url("{{ route('admin.address.search') }}" + "?filterAddress=" + filterAddress + "&filterStatus=" + filterStatus).load();
            });
            ...
            $(document).on('click', '.deleteAddress', function () {
                ...
                $('.deleteAddressForm').attr('action', dataRoute);
            });
