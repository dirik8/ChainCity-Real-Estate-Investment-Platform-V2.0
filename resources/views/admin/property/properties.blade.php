        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">@lang("All Properties")</h1>
                </div>

                @if(adminAccessRoute(config('permissionList.Manage_Property.Properties.permission.add')))
                    <div class="col-sm-auto">
                        <a class="btn btn-primary" href="{{ route('admin.property.create') }}">
                            <i class="fas fa-plus-circle me-1"></i>
                            @lang('Create New Property')
                        </a>
                    </div>
                @endif
                    ...
                    <div class=" table-responsive datatable-custom">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <th scope="col">@lang('Investment Amount')
                                    <span>(@lang('Range/Fixed'))</span></th>
                                <th scope="col">@lang('Target Investment') </th>
                                <th scope="col">@lang('Profit') <span>(%/@lang('Fixed'))</span></th>
    ...
    <div class="modal fade" id="deletePropertyModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="" enctype="multipart/form-data" class="deletePropertyForm">
                    @csrf
                    @method('delete')
                    <div class="modal-body">
                        <p>@lang('Are you sure to delete this property?')</p>
                    </div>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.property.search", $type) }}",
                },
                ...
                columns: [
                    ...
                    {data: 'target_investment', name: 'target_investment'},
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route('admin.property.search', $type) }}" + "?filterProperty=" + filterProperty + "&filterStatus=" + filterStatus).load();
            });
            ...
            $(document).on('click', '.deleteProperty', function () {
                ...
                $('.deletePropertyForm').attr('action', dataRoute);
            });
