...
@section('page_title', __('Create Amenity'))
@section('content')
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.amenities.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4 d-flex align-items-center">
                                    ...
                                    <div class="col-md-5">
                                        <label for="icon" class="form-label">@lang('Icon') (<span><a href="https://fontawesome.com/icons" target="_blank">click here</a> to find icons</span>)</label>
                                        <input type="text" class="form-control  @error('icon') is-invalid @enderror"
                                               name="icon" id="icon" placeholder="@lang("icon class")" aria-label="icon"
                                               autocomplete="off" value="{{ old('icon') }}">
