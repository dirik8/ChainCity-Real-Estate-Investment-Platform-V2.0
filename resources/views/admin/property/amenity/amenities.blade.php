...
@section('content')
        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">@lang("All Amenities")</h1>
                </div>
                @if(adminAccessRoute(config('permissionList.Manage_Property.Amenities.permission.add')))
    ...
    <div class="modal fade" id="deleteAmenitiesModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="" enctype="multipart/form-data" class="deleteAmenitiesForm">
                    @csrf
                    @method('delete')
                    <div class="modal-body">

                        <p>@lang('Are you sure to delete this amenity?')</p>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                let filterTitle = $('#title_filter_input').val();
                let filterStatus = $('#filter_status').val();

                const datatable = HSCore.components.HSDatatables.getItem(0);
                datatable.ajax.url("{{ route('admin.amenities.search') }}" + "?filterTitle=" + filterTitle + "&filterStatus=" + filterStatus).load();
            });
            ...
            $(document).on('click', '.deleteAmenities', function () {
                ...
                $('.deleteAmenitiesForm').attr('action', dataRoute);
            });
