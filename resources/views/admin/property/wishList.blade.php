...
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item"><a class="breadcrumb-link"
                                                           href="javascript:void(0)">@lang("Manage Properties")</a></li>
                            <li class="breadcrumb-item active" aria-current="page">@lang("Wishlist Property")</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang("Wishlist Property")</h1>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="deleteWishlistPropertyModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="" enctype="multipart/form-data" class="deleteWishlistPropertyForm">
                    @csrf
                    @method('delete')
                    <div class="modal-body">
                        <p>@lang('Are you sure to delete this wishlist?')</p>
                    </div>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.property.wishlist.search") }}",
                },
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route('admin.property.wishlist.search') }}" + "?filterProperty=" + filterProperty + "&filterDate=" + filterDate).load();
            });
            ...
            $(document).on('click', '.deleteWishlistProperty', function () {
                let dataRoute = $(this).data('route');
                $('.deleteWishlistPropertyForm').attr('action', dataRoute);
            });
