                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang("Due Investment Details")</li>
                        </ol>
                    </nav>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.due.investment.details.search", $singleProperty->id) }}",
                },
                ...
                columns: [
                    ...
                    {data: 'due_installments', name: 'due_installments'},
                    {data: 'installment_last_date', name: 'installment_last_date'},
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.due.investment.details.search", $singleProperty->id) }}" + "?filterUser=" + filterUser).load();
            });
