...
@section('page_title')
    @lang('Completed Investment Details')
@endsection
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang("Completed Investment Details")</li>
                        </ol>
                    </nav>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.completed.investment.details.search", $singleProperty->id) }}",
                },
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.completed.investment.details.search", $singleProperty->id) }}" + "?filterUser=" + filterUser).load();
            });
