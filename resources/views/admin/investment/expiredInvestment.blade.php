                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang("Expired Investments")</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang("Expired Investments")</h1>
                </div>
            </div>
        </div>
                    ...
                    <div class=" table-responsive datatable-custom">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <th scope="col">@lang('Return Times')</th>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.expired.investment.search") }}",
                },

                columns: [
                    {data: 'no', name: 'no'},
                    {data: 'property', name: 'property'},
                    {data: 'investment_expire_date', name: 'investment_expire_date'},
                    {data: 'invested_user', name: 'invested_user'},
                    {data: 'total_investment_amount', name: 'total_investment_amount'},
                    {data: 'profit_return_date', name: 'profit_return_date'},
                    {data: 'return_times', name: 'return_times'},
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route('admin.expired.investment.search') }}" + "?filterProperty=" + filterProperty).load();
            });
