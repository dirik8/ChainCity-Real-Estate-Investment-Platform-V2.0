...
@section('page_title')
    @lang('Running Investment Details')
@endsection
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang("Running Investment Details")</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang($singleProperty->title) @lang('Investment Details')</h1>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.running.investment.details.search", $singleProperty->id) }}",
                },
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.running.investment.details.search", $singleProperty->id) }}" + "?filterUser=" + filterUser).load();
            });
