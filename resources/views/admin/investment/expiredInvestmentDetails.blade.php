...
@section('page_title')
    @lang('Expired Investment Details')
@endsection
@section('content')
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">@lang("Expired Investment Details")</li>
                        </ol>
                    </nav>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.expired.investment.details.search", $singleProperty->id) }}",
                },
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.expired.investment.details.search", $singleProperty->id) }}" + "?filterUser=" + filterUser).load();
            });
