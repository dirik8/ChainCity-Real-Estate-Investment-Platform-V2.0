                                                ...
                                                <div class="card-body">
                                                    <form id="filter_form">
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-4">
                                                            <span
                                                                class="text-cap text-body">@lang('Property')</span>
                                                                <div class="row">
                                                                    <div class="col-12">
    ...
    <script>
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.user.investment.search", $user->id) }}",
                },
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route('admin.user.investment.search', $user->id) }}" + "?filterProperty=" + filterProperty +
