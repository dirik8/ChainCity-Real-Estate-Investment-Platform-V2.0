...
@section('content')
        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">@lang("Available Roles")</h1>
                </div>
                @if(adminAccessRoute(config('permissionList.Roles_And_Permission.Available_Roles.permission.add')))
                    <div class="col-sm-auto">
                        <a class="btn btn-primary" href="{{route('admin.createRole')}}">
    ...
    <!-- Delete Role Modal -->
    <div class="modal fade" id="deleteRoleModal" tabindex="-1" role="dialog" aria-labelledby="loginAsUserModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="" enctype="multipart/form-data" class="deleteRoleForm">
                    @csrf
                    @method('delete')
                    <div class="modal-body">

                        <p>@lang('Are you sure to delete this role?')</p>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route('admin.roleSearch') }}" + "?filterRole=" + filterRole + "&filterStatus=" + filterStatus).load();
            });
            ...
            $(document).on('click', '.deleteRole', function () {
                ...
                $('.deleteRoleForm').attr('action', dataRoute);
            });
